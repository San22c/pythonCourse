...
for line in fh:
    ...
    #Contabilizamos la linea
    countItems = countItems + 1
    #Buscamos el numero flotante
    pos = line.find(':')
    fitem = float(line[pos+1:].strip())
    countFloat = countFloat + fitem

print("Average spam confidence:", countFloat/countItems)
